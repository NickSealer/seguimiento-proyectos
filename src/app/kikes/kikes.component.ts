...
import { ApiKikesService } from '../services/api-kikes.service';
import { Router } from '@angular/router';
import _get from "lodash/get";

@Component({
  selector: 'app-kikes',
  templateUrl: './kikes.component.html',
  styleUrls: ['./kikes.component.scss']
})
export class KikesComponent implements OnInit {
  project: any = '';
  statistics: any = [];
  milestones: any = [];
  arraydata: any = [];
